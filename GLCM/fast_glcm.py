...
print(glcm_mean.shape)
glcm_std = fast_glcm_std(img, mi, ma, levels, ks)
print(glcm_std.shape)
glcm_contrast = fast_glcm_contrast(img, mi, ma, levels, ks)
print(glcm_contrast.shape)
glcm_dissimilarity = fast_glcm_dissimilarity(img, mi, ma, levels, ks)
print(glcm_dissimilarity.shape)
glcm_homogeneity = fast_glcm_homogeneity(img, mi, ma, levels, ks)
print(glcm_homogeneity.shape)
glcm_asm = fast_glcm_ASM(img, mi, ma, levels, ks)
print([len(a) for a in glcm_asm])
glcm_max = fast_glcm_max(img, mi, ma, levels, ks)
print(glcm_max.shape)
glcm_entropy = fast_glcm_entropy(img, mi, ma, levels, ks)
print(glcm_entropy.shape)